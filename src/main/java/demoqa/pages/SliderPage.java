...
public class SliderPage extends BasePage {
    ...
    public SliderPage moveSliderWithJS(Integer targetValue) {
        ...
        String script = "arguments[0].value = arguments[1]; " + "arguments[0].dispatchEvent(new Event('input')); " + "arguments[0].dispatchEvent(new Event('change'));" + "document.getElementById('sliderValue').value = arguments[1]";
